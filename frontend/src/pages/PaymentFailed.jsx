    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 flex items-center justify-center p-4">
      <div className="bg-white p-10 rounded-2xl shadow-2xl text-center max-w-md w-full border-4 border-red-400 relative overflow-hidden">
        ...
        <p className="text-red-600 mb-6 text-lg">
          Your eSewa payment was cancelled or failed. You have <span className="font-bold">not</span> been charged.
        </p>

        <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 mb-6 text-left space-y-2">
          <p className="text-sm font-semibold text-red-700">Common reasons:</p>
